...
class AppStrings {
  ...
  static const Map<AppLanguage, Map<String, String>> _localizedValues = {
    AppLanguage.english: {
      ...
      'all': 'All',
      ///////
'checkYourInboxTitle': 'Check your inbox (in Spam)',
'verificationEmailSentTo':
    'We sent a verification link to\n{email}\nPlease click it to activate your account.',
'verifiedContinue': "I've verified — continue",
'resendEmail': 'Resend email',
'resendEmailCooldown': 'Resend email ({seconds}s)',
...
///////////////
    ...
    AppLanguage.arabic: {
      ...
      'all': 'الكل',
      ///////////////////////
      'checkYourInboxTitle': 'تحقق من بريدك الإلكتروني (وتفقد الرسائل غير المرغوب فيها)',
'verificationEmailSentTo':
    'لقد أرسلنا رابط تفعيل إلى\n{email}\nيرجى الضغط عليه لتفعيل حسابك.',
'verifiedContinue': 'تم التفعيل — متابعة',
'resendEmail': 'إعادة إرسال البريد',
'resendEmailCooldown': 'إعادة الإرسال ({seconds} ث)',
