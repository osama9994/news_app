...
class BreakingNewsAllPage extends StatelessWidget {
  const BreakingNewsAllPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocListener<LanguageCubit, LanguageState>(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: Text(tr.text('breakingNews')),
            leading: Padding(
              ...
              child: BlocBuilder<ViewAllNewsCubit, ViewAllNewsState>(
                builder: (context, state) {
                  ...
                  if (state is ViewAllNewsLoaded) {
                    ...
                    if (articles.isEmpty) {
                      return Center(
                        child: Text(tr.text('noBreakingNewsAvailable')),
                      );
                    }
