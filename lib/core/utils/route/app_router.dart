...
import 'package:news_app/features/login/views/pages/verify_email_page.dart';
...
class AppRouter {
  ...
  final targetRoute = settings.arguments as String? ?? AppRoutes.home;
  return MaterialPageRoute(
    builder: (_) => VerifyEmailPage(successRoute: targetRoute),
    settings: settings,
  );
      case AppRoutes.home:
